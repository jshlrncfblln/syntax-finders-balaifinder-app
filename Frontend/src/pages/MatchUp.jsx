...
import ScoringSettingsModal from "../components/ScoringSettings";
  ...
  const handleSubmitPreferences = (data) => {
    ...
    return (
        <div>
                ...
                <div class="mx-auto flex flex-col items-center py-12 sm:py-24">
                    ...
                    <div class="flex w-11/12 md:w-8/12 xl:w-6/12">
                        <div class="flex rounded-md w-full items-center justify-center">
                            <button onClick={openSettingsModal} class="flex items-center gap-2 bg-sky-500 text-white text-lg font-semibold py-3 px-6 rounded-md hover:bg-sky-700 sm:py-2 sm:px-4">
                        ...
                        <div class="flex rounded-md w-full items-center justify-center">
                            <button onClick={openScoringModal} class="flex items-center gap-2 bg-sky-500 text-white text-lg font-semibold py-3 px-6 rounded-md hover:bg-sky-700">
                                <span>Customize your Priority</span>
                                <svg class="text-gray-200 h-5 w-5 p-0 fill-current" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px"
                                    viewBox="0 0 56.966 56.966" style={{ enableBackground: 'new 0 0 56.966 56.966' }}
                                    xml:space="preserve">
            ...
            {showScoringModal && <ScoringSettingsModal onClose={closeScoringModal} />}
            <Footer/>
        </div>
    )
}
