  ...
  const handleSubmit = async (e) => {
    ...
    if (formValid) {
      try {
        ...
        formData.append('monthly', property.monthly);
        formData.append('nearelementary', property.nearelementary);
        formData.append('nearhighschool', property.nearhighschool);
        formData.append('nearcollege', property.nearcollege);
        formData.append('nearmall', property.nearmall);
        formData.append('nearchurch', property.nearchurch);
        formData.append('numBedrooms', property.numBedrooms);
        formData.append('numBathrooms', property.numBathrooms);
        formData.append('typeoflot', property.typeoflot);
        formData.append('familysize', property.familysize);
        formData.append('businessready', property.businessready);
        formData.append('description', property.description);
        formData.append('image1', property.image1); // Append the image file
