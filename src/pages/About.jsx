        ...
        <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 mt-16">
            <div className="order-2 md:order-1 md:text-right">
              ...
              {/*Social Media Links*/}
              <div className="mt-8 mb-8 flex justify-center">
                <a href="https://www.facebook.com/shirensui?mibextid=JRoKGi" className="flex items-center justify-start m-2"><FaFacebook className="size-10"/><span className="ml-2">Alryan Licup</span></a>
                <a href="https://github.com/AruLicup" className="flex items-center justify-start m-2"><FaGithub className="size-10"/><span className="ml-2">AruLicup</span></a>
              </div>
              <hr class="border-t-2 border-gray-900" />
            </div>
            <div className="order-1 md:order-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 mt-16">
            ...
            <div className="order-1 md:order-2">
              ...
              {/*Social Media Links*/}
              <div className="mt-8 mb-8 flex justify-center">
                <a href="https://www.facebook.com/steven.boloy.7?mibextid=ZbWKwL" className="flex items-center justify-start m-2"><FaFacebook className="size-10"/><span className="ml-2">Steven Boloy</span></a>
                <a href="https://www.instagram.com/stevenboloy?igsh=MWNzbWRmNnVxYXN3aw==" className="flex items-center justify-start m-2"><FaInstagram className="size-10"/><span className="ml-2">stevenboloy</span></a>
                <a href="https://github.com/StevenDaniel16" className="flex items-center justify-start m-2"><FaGithub className="size-10"/><span className="ml-2">StevenDaniel16</span></a>
              </div>
              <hr class="border-t-2 border-gray-900" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 mt-16">
            <div className="order-2 md:order-1 md:text-right">
              ...
              {/*Social Media Links*/}
              <div className="mt-8 mb-8 flex justify-center">
                <a href="https://www.facebook.com/JimLy.ParkJimin28?mibextid=ZbWKwL" className="flex items-center justify-start m-2"><FaFacebook className="size-10"/><span className="ml-2">Lyka Mae Fortuna</span></a>
                <a href="https://www.instagram.com/mey_2_u?igsh=MTlmeWdmanV0ang5aw==" className="flex items-center justify-start m-2"><FaInstagram className="size-10"/><span className="ml-2">mey_2_u</span></a>
                <a href="https://github.com/LYKAMAEEE" className="flex items-center justify-start m-2"><FaGithub className="size-10"/><span className="ml-2">LYKAMAEEE</span></a>
              </div>
              <hr class="border-t-2 border-gray-900" />
            </div>
            <div className="order-1 md:order-2">
