...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2024 at 02:06 PM
...
INSERT INTO `propertiestable` (`id`, `name`, `type`, `location`, `price`, `isnearschool`, `isnearchurch`, `isnearmall`, `numberofbedroom`, `numberofbathroom`, `typeoflot`, `nearelementary`, `nearhighschool`, `nearcollege`, `plantodobusiness`, `monthly`, `description`, `imgsrc`) VALUES
...
INSERT INTO `userpreferencestable` (`id`, `user_id`, `type`, `location`, `price`, `isnearschool`, `isnearchurch`, `isnearmall`, `numberofbedroom`, `numberofbathroom`, `typeoflot`, `nearelementary`, `nearhighschool`, `nearcollege`, `plantodobusiness`, `monthly`, `description`, `imgsrc`) VALUES
(1, '1', 'Apartment', 'Mandaluyong', '2600000', 'YES', 'NO', 'YES', '', '', '', '', '', '', '', '', '', '');
