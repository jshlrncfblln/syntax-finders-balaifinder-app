...
-- Generation Time: Mar 29, 2024 at 06:02 AM
...
CREATE TABLE `propertiestable` (
  ...
  `plantodobusiness` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
(1, '1', 'Apartment', 'Makati CBD', '1500000', 'YES', 'YES', 'YES', '1', '1', 'End Lot', 'Small', '', '', '', '', '', '', '');
...
(4, 'Te', 'St', 'testtest@test.com', '$2a$10$PYCxXcVmqDu9B0MvJAUeFuXhTPn44tkPfJM52vVfqVSD7lSK0FQMS', '2001-12-12', 'Male', 'Test Street 123', '01', '0133', '013312'),
(6, 'valid', 'test', 'validtest@valid.com', '$2a$10$yoi6Axn5DGAy7IQMA7YOk.WwxcHnPhgZtAQtgx.1VRPcjpJYSGj3C', '1998-02-03', 'Female', '123 My House', '04', '0421', '042110'),
